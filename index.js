...
function createHeaderPostContainer(i) {
  ...
  setAttributes(imgAvatar, {
    src: postData[i].avatar,
    alt: postData[i].altAvatar,
    class: classAttribute.classAvatar,
  });
...
function createImagePost(i) {
  ...
  setAttributes(imgPost, {
    src: postData[i].imagePost,
    alt: postData[i].altPost,
    class: classAttribute.classImagePost,
  });
...
function createIconsContainer(i) {
  ...
  setAttributes(imgHeart, {
    src: iconImages.iconHeart,
    alt: iconImages.altHeart,
    class: classAttribute.classIcons,
  });
  ...
  setAttributes(imgComment, {
    src: iconImages.iconComment,
    alt: iconImages.altComment,
    class: classAttribute.classIcons,
  });
  setAttributes(imgDm, {
    src: iconImages.icondDm,
    alt: iconImages.altDm,
    class: classAttribute.classIcons,
  });
